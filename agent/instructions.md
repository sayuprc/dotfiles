...
- セッション開始時に、`.agent/lessons.md` をレビューする
...
1. **まず計画を立てる**：チェック可能な項目として `.agent/todo.md` に計画を書く
2. **計画を確認する**：実装を開始する前に確認する
3. **進捗を記録する**：完了した項目を随時マークしていく
4. **変更を説明する**：各ステップで高レベルのサマリーを提供する
5. **結果をドキュメント化する**：`.agent/todo.md` にレビューセクションを追加する
6. **学びを記録する**：修正を受けた後に `.agent/lessons.md` を更新する
